...
export default StyleSheet.create({
    ...
    container: { flex: 1 },
    scrollContainer: { padding: 20, paddingBottom: 40, backgroundColor: '#f8fafc' },
    header: { alignItems: 'center', marginBottom: 30, paddingVertical: 20 },
    title: { fontSize: 28, fontWeight: '700', color: '#1e3a8a', marginTop: 16, marginBottom: 8, textAlign: 'center' },
    ...
    imageCard: { height: 140, borderRadius: 12, marginBottom: 16, overflow: 'hidden', backgroundColor: '#e2e8f0', borderWidth: 1, borderColor: '#cbd5e1' },
    imageContainer: { flex: 1, position: 'relative' },
    uploadedImage: { width: '100%', height: '100%' },
    changeImageOverlay: { position: 'absolute', bottom: 8, right: 8, backgroundColor: 'rgba(0,0,0,0.6)', borderRadius: 20, padding: 8 },
